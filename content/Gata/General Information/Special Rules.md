...
- A player earns 3 SPP for causing a Casualty instead of 2 SPP.
- A player earns 2 SPP for scoring a Touchdown instead of 3 SPP.

## Bribery and Corruption

Teams with this rule have improved access to referee-related inducements:

- They may buy up to 3 Bribes for 50k each.
- These Bribes increase Team Value.
- Biased Referee costs 60k for teams with Bribery and Corruption.
...
| Alignment | Trigger | Bonus skill list |
| --- | --- | --- |
...
Teams with this rule can also buy Rowdy Rookies.

## Masters of Undeath

When a team with this rule kills an opposition player, the coach gains a Lineman from their own team roster. Shambling Undead may choose either a Skeleton or a Zombie.

Teams with this rule can also buy Mortuary Assistant.
...
During the Start of Drive sequence, after both teams have set up, a team with this rule may set up D3+1 additional Lineman players from its Reserves box, following the normal setup rules. This can take the team above the normal pitch limit.

## Team Captain

Every team has a Team Captain:

- Nominate a Captain on the roster.
- The Captain gains Pro.
- The Captain must be set up if able.
- While the Captain is on the pitch, when you use a Team Re-roll, roll a D6. On a 5+, the Team Re-roll is not spent.
- Ogre teams may nominate an Ogre Runt Punter as their Captain.
